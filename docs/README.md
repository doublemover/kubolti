...
- `compatibility.md` describes supported platforms, Python versions, and tool policies.
...
- `tool_paths.template.json` is a starting point for `tools/tool_paths.json`.
- `release_notes.md` is the draft release summary for the next tag.
- `quickstarts/` contains platform-specific setup notes (Windows, macOS, Linux).
- `security_posture.md` documents download/extraction trust assumptions.

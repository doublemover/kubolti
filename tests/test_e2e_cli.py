...
@pytest.mark.xfail(reason="Tile inference not implemented yet.", strict=True)
...
@pytest.mark.xfail(reason="AOI-driven builds not implemented yet.", strict=True)
...
@pytest.mark.xfail(reason="Publish modes not implemented yet.", strict=True)
